        ...
        <div className={`space-y-4 ${className}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {videos.map((video, idx) => (
                    <div key={idx} className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group flex flex-col">
                        ...
                        <div className="absolute top-0 right-0 p-3 opacity-0 group-hover:opacity-100 transition-opacity z-10">
                            <a href={video.video_url} target="_blank" rel="noopener noreferrer" className="p-2 bg-blue-50/90 dark:bg-blue-900/90 backdrop-blur-sm text-blue-600 rounded-full hover:bg-blue-100 dark:hover:bg-blue-800 transition-colors block">
                                <ExternalLink className="w-4 h-4" />
                            </a>
                        </div>

                        {/* Top Left: Rank */}
                        <div className="absolute top-0 left-0 bg-zinc-100/90 dark:bg-zinc-800/90 backdrop-blur-sm text-[10px] font-bold text-zinc-500 px-2 py-1 rounded-br-lg z-10 shadow-sm">
                            #{video.rank}
                        </div>
                        ...
                        <div className="p-4 flex flex-col flex-grow">
                            ...
                            <div className="mt-auto grid grid-cols-3 gap-2 text-xs text-zinc-600 dark:text-zinc-400 pt-3 border-t border-zinc-100 dark:border-zinc-800">
